...
/**
	* @brief  initialize imu mpu6500 and magnet meter ist3810//初始化imu mpu6500和磁力计ist3810
  * @param  
	* @retval 
  * @usage  call in main() function
	*/
...
/**
	* @brief  get the offset data of MPU6500//获取MPU6500的偏移数据
  * @param  
	* @retval 
  * @usage  call in main() function
	*/
...
/**
	* @brief  Initialize quaternion//初始化四元数
  * @param  
	* @retval 
  * @usage  call in main() function
	*/
...
/**
	* @brief  update imu AHRS//更新imu AHRS
  * @param  
	* @retval 
  * @usage  call in main() function
	*/
...
/**
	* @brief  update imu attitude//更新imu姿态
  * @param  
	* @retval 
  * @usage  call in main() function
	*/
